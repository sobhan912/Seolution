package com.example.timetochange.RecyclersView.ProductDetail;
...
public class ProductDetailAdapter extends RecyclerView.Adapter<ProductDetailAdapter.MyViewHolder> {
    ...
    public ProductDetailAdapter(List<ProductsModel> products, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.product_detail_similar, parent, false);
